    ...
    <div className="bg-header h-[80vh]">
      <div className="max-w-screen-xl h-full mx-auto flex justify-between items-center">
        <div className='flex-1 data-aos="fade-left" data-aos-id="super-duper"  rounded-3xl  flex items-center justify-center'>
          <div className="">
            <h3 className="uppercase text-2xl md:text-3xl lg:text-5xl text-center font-extrabold font-mono text text-white px-5">
            ...
            <div className="text-center flex gap-x-5 justify-center py-3">
              <button className="btn border-2 text-white bg-teal-800 border-3">
            ...
            <div className="flex justify-center gap-5 pt-2 z-40">
              <a href="https://www.facebook.com/md.ansarulislam.641" target="_blank" rel="noopener noreferrer"> <BsFacebook size={30} className=" text-blue-900 cursor-pointer" /></a>
             
              <a href="https://www.linkedin.com/in/md-ansarul-haque/" target="_blank" rel="noopener noreferrer">
              <BsLinkedin size={30} className=" text-indigo-200 cursor-pointer"/>
              </a>
              <a href="https://github.com/mdansarulislam641" target="_blank" rel="noopener noreferrer">
              <BsGithub size={30} className=" text-gray-700 cursor-pointer"/>
              </a>
